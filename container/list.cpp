...
void BasicSetMemberTypes() {
    ...
    if(std::is_same<std::list<int>::reverse_iterator, std::reverse_iterator<std::_List_iterator<int>>>::value) {
        std::cout << "list_int.reverse_iterator is std::reverse_iterator<std::_List_iterator<int>>" << std::endl;
    } else {
        std::cout << "list_int.reverse_iterator is not std::reverse_iterator<std::_List_iterator<int>>" << std::endl;
    }
    if(std::is_same<std::list<int>::const_reverse_iterator, std::reverse_iterator<std::_List_const_iterator<int>>>::value) {
        std::cout << "list_int.const_reverse_iterator is std::reverse_iterator<std::_List_const_iterator<int>>" << std::endl;
    } else {
        std::cout << "list_int.const_reverse_iterator is not std::reverse_iterator<std::_List_const_iterator<int>>" << std::endl;
    }
...
void MemFun() {
    ...
    std::cout << "mylist3.begin(): " << *mylist3.begin() << ", mylist3.size: " << mylist3.size() << std::endl;
    std::cout << "mylist4.size(): " << mylist4.size() << std::endl;
    mylist3.splice(mylist3.begin(), mylist5, mylist5.begin());
    std::cout << "mylist3.begin(): " << *mylist3.begin() << ", mylist3.size: " << mylist3.size() << std::endl;
    std::cout << "mylist5.begin(): " << *mylist5.begin() << ", mylist5.size: " << mylist5.size() << std::endl;
