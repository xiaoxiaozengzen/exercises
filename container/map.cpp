...
void BasicSetMemberTypes() {
  ...
  if (std::is_same<std::map<double, int>::allocator_type,
  ...
  if (std::is_same<std::map<double, int>::const_reference,
  ...
  if (std::is_same<std::map<double, int>::const_pointer,
                   const std::pair<const double, int>*>::value) {
    std::cout << "map::const_pointer is const std::pair<const double, int>*" << std::endl;
  }
  if (std::is_same<std::map<double, int>::iterator,
                   std::_Rb_tree_iterator<std::pair<const double, int>>>::value) {
    std::cout << "map::iterator is std::_Rb_tree_iterator<std::pair<const double, int>>"
              << std::endl;
  }
  if (std::is_same<std::map<double, int>::const_iterator, int>::value) {
    std::cout << "map::const_iterator is std::_Rb_tree_const_iterator<std::pair<const double, int>>"
              << std::endl;
  }
  if (std::is_same<std::map<double, int>::reverse_iterator, int>::value) {
    std::cout << "map::reverse_iterator is "
                 "std::reverse_iterator<std::_Rb_tree_iterator<std::pair<const double, int>>"
              << std::endl;
  }
  if (std::is_same<std::map<double, int>::const_reverse_iterator, int>::value) {
    std::cout << "map::const_reverse_iterator is "
                 "std::reverse_iterator<std::_Rb_tree_const_iterator<std::pair<const double, int>>"
              << std::endl;
  }
...
void ConstructFun() {
  ...
  std::map<char, int> fifth = {{'a', 10}, {'b', 30}, {'c', 50}, {'d', 70}};
}

void MemberFun() {
  std::map<char, int> map1 = {{'a', 1}, {'b', 2}, {'c', 3}, {'d', 4}};
  ...
  std::map<char, int> map2 = {{'h', 7}, {'i', 8}, {'j', 9}};
  ...
  if (ret5.second == true) {
    std::cout << "emplace success, " << ret5.first->first << ", " << ret5.first->second
              << std::endl;
  } else {
  ...
  if (ret6.second == true) {
    std::cout << "emplace success, " << ret6.first->first << ", " << ret6.first->second
              << std::endl;
  } else {
    std::cout << "emplace failed" << std::endl;
  }
  ...
  std::pair<std::map<char, int>::iterator, std::map<char, int>::iterator> ret7 =
      map1.equal_range('a');
  if (ret7.first != map1.end()) {
    std::cout << "equal_range first: " << ret7.first->first << ", " << ret7.first->second
              << std::endl;
  } else {
    std::cout << "equal_range first failed" << std::endl;
  }
  if (ret7.second != map1.end()) {
    std::cout << "equal_range second: " << ret7.second->first << ", " << ret7.second->second
              << std::endl;
  } else {
    std::cout << "equal_range second failed" << std::endl;
  }
  std::pair<std::map<char, int>::iterator, std::map<char, int>::iterator> ret8 =
      map1.equal_range('c');
  if (ret8.first != map1.end()) {
    std::cout << "equal_range first: " << ret8.first->first << ", " << ret8.first->second
              << std::endl;
  } else {
    std::cout << "equal_range first failed" << std::endl;
  }
  if (ret8.second != map1.end()) {
    std::cout << "equal_range second: " << ret8.second->first << ", " << ret8.second->second
              << std::endl;
  } else {
    std::cout << "equal_range second failed" << std::endl;
  }
